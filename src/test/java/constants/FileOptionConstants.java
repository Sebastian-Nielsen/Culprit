...
public class FileOptionConstants {
	...
	public static final String ARBITRARY_KEY_1 = "" + ID;
	...
	public static final String ARBITRARY_KEY_2 = "" + ID;
	public static final String ARBITRARY_VAL_2 = "686b09f2-9e99-42b3-b2dc-576b43e95cbf";
	public static final String ARBITRARY_FILEOPTION_2 = FILEOPTION_TEMPLATE.formatted(ARBITRARY_KEY_2, ARBITRARY_VAL_2);

	public static final String ARBITRARY_KEY_3 = "" + ID;
