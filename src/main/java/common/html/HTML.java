...
public class HTML {
    ...
    public static class Tag {
        ...
        static final Tag[] allTags  = {
            A, ARTICLE, ASIDE, ADDRESS, NAV, APPLET, AREA, B, BASE, BASEFONT, BIG,
    ...
    public static final class Attribute {
	     ...
	     * Attribute "charset"
	     */
	    public static final Attribute CHARSET = new Attribute("charset");
     ...
     * COLOR, CHARSET, CLEAR, BACKGROUND, BGCOLOR, TEXT, LINK, VLINK, ALINK,
